...
stargazer(lm_i_identify, lm_i_prefer, lm_o_prefer, lm_validate, header=F, type='text')
```
...
stargazer(lm_i_identify_, lm_i_prefer_, lm_o_prefer_, lm_validate_, header=F, type='text')
```
