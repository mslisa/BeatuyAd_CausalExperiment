...
#Change Directory
raw_data <- read.csv('/Users/lisam/Documents/Berkeley/W241_CausalExperiments/BeatuyAd_CausalExperiment/Data/BeautyAds_July 19, 2017_22.18.csv')
...
#   print(summary(question_average))
# }
...
stargazer(lm_i_identify, lm_i_prefer, lm_o_prefer, lm_validate, header=F, type='text', column.labels = c("Identify", "I Prefer", "Others Prefer", "Validate"))
...
```{r}
raw_data2 <- read.csv('/Users/lisam/Documents/Berkeley/W241_CausalExperiments/BeatuyAd_CausalExperiment/Data/BeautyAds_August 12, 2017_21.50.csv')
...
stargazer(lm_i_identify_, lm_i_prefer_, lm_o_prefer_, lm_validate_, header=F, type='text', column.labels = c("Identify", "I Prefer", "Others Prefer", "Validate"))
